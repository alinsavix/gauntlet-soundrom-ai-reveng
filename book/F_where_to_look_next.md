...
| [15. Case Studies](15_case_studies.md) | Everything, especially [`04_subsystems.md`](../docs/04_subsystems.md) and [`06_sequence_engine.md`](../docs/06_sequence_engine.md); [`soundcmds.csv`](../soundcmds.csv) for names | [`type7_chain_catalog.csv`](../docs/generated/type7_chain_catalog.csv), [`type7_sequence_catalog.csv`](../docs/generated/type7_sequence_catalog.csv), [`type11_speech_catalog.csv`](../docs/generated/type11_speech_catalog.csv) |
...
| [17. What We Still Don't Know](17_open_questions.md) | [`10_known_issues.md`](../docs/10_known_issues.md), [`03_rom_structure.md`](../docs/03_rom_structure.md) unused space | [`external_question_catalog.csv`](../docs/generated/external_question_catalog.csv), [`external_evidence_inventory.csv`](../docs/generated/external_evidence_inventory.csv), [`operator_sound_test_command_catalog.csv`](../docs/generated/operator_sound_test_command_catalog.csv), [`reserved_handler_catalog.csv`](../docs/generated/reserved_handler_catalog.csv), [`type7_residual_catalog.csv`](../docs/generated/type7_residual_catalog.csv) |
...
| [B. Command List](B_command_list.md) | [`command_catalog.csv`](../docs/generated/command_catalog.csv), [`type7_chain_catalog.csv`](../docs/generated/type7_chain_catalog.csv), [`type11_speech_catalog.csv`](../docs/generated/type11_speech_catalog.csv), [`soundcmds.csv`](../soundcmds.csv) |
...
| What does a sequence actually contain? | `uv run gauntlet_disasm.py --cmd 0xNN` |
