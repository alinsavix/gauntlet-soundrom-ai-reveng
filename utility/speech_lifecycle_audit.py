...
ROWS = [
    ...
    (0x59E2, 0x5A0A, "callable_subroutine", "atomic seven-item priority queue insertion into eight physical slots", "$5936 and busy speech requests", "A=parameter; X=incoming priority", "RTS $5A0A; full is rejected before priority comparison; otherwise reject lower, append equal, or flush/append higher", "A,Y,P", "$0832-$0833;$35", "$0832 on higher-priority flush;$0833;$0834-$083B;$35", "Verified", "Trace representative runtime phrase bursts"),
]
